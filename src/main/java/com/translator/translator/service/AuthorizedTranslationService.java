...
public class AuthorizedTranslationService {
    ...
    public List<String> verifyTranslate( String srcLan, 
            String destLang,  String text, int id) throws JsonProcessingException {
        Optional<User> userOptional = Optional.ofNullable(userService.getUserById((long) id));
        ...
        if (userOptional.isEmpty()) {
            ...
            translationService.createTranslation((long) id, newTranslation);
            return result;
        }
    }
}
